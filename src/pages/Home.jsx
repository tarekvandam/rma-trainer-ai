    ...
    <div className="animate-fade-in space-y-8">
      <div className="flex flex-col items-center gap-4 pt-8 text-center">
        ...
        <h1 className="text-3xl font-bold tracking-tight md:text-5xl">
          <span className="text-rmared-500">RMA</span> Trainer AI
        </h1>
        <p className="max-w-md text-lg text-zinc-400">
          مدربك الشخصي للفنون القتالية واللياقة — خطط تدريب ذكية مبنية على أهدافك وإمكانياتك
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {[
          { icon: '🎯', title: 'خطط مخصصة', desc: 'حسب هدفك، مستواك، أيامك، ومعداتك' },
          { icon: '🧠', title: 'ذكاء تدريبي', desc: 'منهجية realistica مستوحاة من RMA' },
          { icon: '📊', title: 'نتائج حقيقية', desc: 'لا وعود كاذبة — تطور ثابت وآمن' },
        ].map((item) => (
